    ...
    <div class="container mt-5">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="peribadi" role="tabpanel" aria-labelledby="peribadi-tab">
                <form action="{{ route('pekerjas.update', $pekerja->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        {{-- <input type="status" class="form-control" id="status" name="status" value="{{ $pekerja->status }}" required> --}}
            ...
            <div class="tab-pane fade" id="pasangan" role="tabpanel" aria-labelledby="pasangan-tab">
                <form action="{{ route('pasangans.update', $pasangan->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_pekerja" name="id_pekerja" value="{{ $pasangan->id_pekerja }}" required disabled>
                    </div>
                    <div class="form-group">
                        <label for="nricpasangan">No. Kad Pengenalan Pasangan:</label>
                        <input type="text" class="form-control" id="nricpasangan" name="nricpasangan" value="{{ $pasangan->nricpasangan }}" required>
                    </div>
                    <div class="form-group">
                        <label for="namapasangan">Nama Pasangan:</label>
                        <input type="text" class="form-control" id="namapasangan" name="namapasangan" value="{{ $pasangan->namapasangan }}" required>
                    </div>
                    <div class="form-group">
                        <label for="hubungan">Hubungan:</label>
                        <input type="text" class="form-control" id="hubungan" name="hubungan" value="{{ $pasangan->hubungan }}" required>
                    </div>
                    <div class="form-group">
                        <label for="notel">No Tel:</label>
                        <input type="text" class="form-control" id="notel" name="notel" value="{{ $pasangan->notel }}" required>
                    </div>
            ...
            <div class="tab-pane fade" id="waris" role="tabpanel" aria-labelledby="waris-tab">
                <!-- Add fields for Maklumat Waris here -->
            </div>

            <!-- Maklumat Jawatan -->
            <div class="tab-pane fade" id="jawatan" role="tabpanel" aria-labelledby="jawatan-tab">
                <!-- Add fields for Maklumat Jawatan here -->
            </div>
